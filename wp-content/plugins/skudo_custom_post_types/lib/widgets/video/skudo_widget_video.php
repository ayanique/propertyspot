...
class Skudo_Video_Widget extends WP_Widget {
	function __construct() {
		$widget_ops = array('classname' => 'video_widget', 'description' => esc_html__('Show your videos from Youtube or Vimeo.', 'skudo'));
...
?>  
    ...
    <p><label>&#8212; <?php esc_html_e('Video Hoster', 'skudo'); ?> &#8212;<br>
		<input type="radio" name="<?php echo esc_attr($this->get_field_name('v_type')); ?>" value="you" <?php if($order == 'you' || !$order) echo 'checked'; ?>> <?php esc_html_e('Youtube', 'skudo'); ?><br>
		<input type="radio" name="<?php echo esc_attr($this->get_field_name('v_type')); ?>" value="vim" <?php if($order == 'vim') echo 'checked'; ?>> <?php esc_html_e('Vimeo', 'skudo'); ?><br>
    </label></p>
    <p><label for="<?php echo esc_attr($this->get_field_id('v_id')); ?>">&#8212; <?php esc_html_e('Video ID', 'skudo'); ?> &#8212;<input class="widefat" id="<?php echo esc_attr($this->get_field_id('v_id')); ?>" name="<?php echo esc_attr($this->get_field_name('v_id')); ?>" type="text" value="<?php echo esc_attr($v_id); ?>" /></label></p>
...
register_widget('Skudo_Video_Widget');
