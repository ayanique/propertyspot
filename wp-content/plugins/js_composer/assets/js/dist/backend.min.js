...
window.upper_color_picker_value=value;
var upper_is_this_color_selected=value=='__USE_THEME_MAIN_COLOR__' ? ' checked=\'checked\' ' : '';
var upper_color_picker_id='_' + Math.random().toString(36).substr(2, 9);
var upper_output='<div class=\'use_theme_main_color_container '+window.upper_color_picker_id+'\' style=\'margin: 10px 0px; \'><label>Use Theme Main Color ? <input name=\'use_theme_main_color\' type=\'checkbox\' '+upper_is_this_color_selected+' onchange=\' if (jQuery(this).is(":checked")) { jQuery(this).closest(".use_theme_main_color_container").siblings().find("input.wp-color-picker").val("__USE_THEME_MAIN_COLOR__"); jQuery(this).closest(".use_theme_main_color_container").siblings().fadeOut(); } else { jQuery(this).closest(".use_theme_main_color_container").siblings().find("input.wp-color-picker").val(""); jQuery(this).closest(".use_theme_main_color_container").siblings().fadeIn(); } \' /></label></div>';
$pickerContainer.prepend($(upper_output));
...
if(typeof window.upper_color_picker_value != "undefined" && window.upper_color_picker_value=='__USE_THEME_MAIN_COLOR__') {
	jQuery('.use_theme_main_color_container.'+window.upper_color_picker_id+' input[name="use_theme_main_color"]').trigger('click').trigger('click');
}	
