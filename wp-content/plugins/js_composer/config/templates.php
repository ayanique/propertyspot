...
/* UPPER UPPER UPPER */ 
/* we removed the default templates which weren't being used anywhere */
/* we'll now call our own templates by calling our function. */
/* still need to verify if our plugin function is loaded or not */
/* frontend usually isn't, for some reason. */

if (!function_exists('upper_studio_templates_for_vc') && defined('SKUDO_PLG_PATH') && file_exists(SKUDO_PLG_PATH."lib/upper-studio/upper-studio-templates.php")) 
	require_once(SKUDO_PLG_PATH."lib/upper-studio/upper-studio-templates.php");

if (function_exists('upper_studio_templates_for_vc')) upper_studio_templates_for_vc();
else {
