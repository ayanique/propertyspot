...
$ginza_mainextraclass = NULl;
if($ginza_blogsidebar=='left') {
	$ginza_mainextraclass = 'order-lg-last';
}
switch($ginza_bloglayout) {
	...
	default:
		...
		Ginza_Class::ginza_post_thumbnail_size('ginza-category-thumb');
}
?>
<div class="main-container <?php if(isset($ginza_opt['blog_banner']['url']) && ($ginza_opt['blog_banner']['url'])!=''){ echo 'has-image';} ?>">
	...
	<div class="container">
		<div class="row">
			<div class="col-12 <?php echo 'col-lg-'.$ginza_blogcolclass; ?> <?php echo esc_attr($ginza_mainextraclass);?>">
						...
						<article id="post-<?php the_ID(); ?>" <?php post_class( 'image-attachment' ); ?>>
							<div class="entry-content">
								<div class="post-thumbnail">
									<div class="entry-attachment">
										<div class="attachment">
											 ...
											 * }
											 */
											$attachment_size = apply_filters( 'ginza_attachment_size', array( 960, 960 ) );
								...
								<div class="entry-description">
									<?php the_content(); ?>
									<?php wp_link_pages( array( 'before' => '<div class="page-links">' . esc_html__( 'Pages:', 'ginza' ), 'after' => '</div>' ) ); ?>
								...
								<div class="post-info">
									...
									<footer class="entry-meta">
										<?php
											...
											printf( wp_kses(__( '<span class="meta-prep meta-prep-entry-date">Published </span> <span class="entry-date"><time class="entry-date" datetime="%1$s">%2$s</time></span> at <a href="%3$s">%4$s &times; %5$s</a> in <a href="%6$s" rel="gallery">%8$s</a>.', 'ginza' ), array('span'=>array('class'=>array()), 'a'=>array('href'=>array(), 'title'=>array(), 'rel'=>array()), 'time'=>array('class'=>array(), 'datetime'=>array()))),
										...
										?>
										<?php edit_post_link( esc_html__( 'Edit', 'ginza' ), '<span class="edit-link">', '</span>' ); ?>
									</footer><!-- .entry-meta -->
								</div>
							</div>
						</article><!-- #post -->
