...
$ginza_shopclass = Ginza_Class::ginza_shop_class('');
$colwidth = 3;
if($ginza_shopclass=='shop-fullwidth') {
	if(isset($ginza_opt['product_per_row_fw'])){
		$woocommerce_loop['columns'] = $ginza_opt['product_per_row_fw'];
	...
	if(isset($ginza_opt['product_per_row'])){
		$woocommerce_loop['columns'] = $ginza_opt['product_per_row'];
		if($woocommerce_loop['columns'] > 0){
			$colwidth = round(12/$woocommerce_loop['columns']);
		}
	}
...
$colwidth_over1400 = 3;
if($ginza_shopclass=='shop-fullwidth') {
	if(isset($ginza_opt['product_per_row_fw_over1400'])){
		$woocommerce_loop['columns_over1400'] = $ginza_opt['product_per_row_fw_over1400'];
		if($woocommerce_loop['columns_over1400'] > 0){
			$colwidth_over1400 = 'col-over-1400 col-over1400-'.$ginza_opt['product_per_row_fw_over1400'];
		}
		$classes[] = $colwidth_over1400 ;
	}
} else {
	if(isset($ginza_opt['product_per_row_over1400'])){
		$woocommerce_loop['columns_over1400'] = $ginza_opt['product_per_row_over1400'];
		if($woocommerce_loop['columns_over1400'] > 0){
			$colwidth_over1400 = 'col-over-1400 col-over1400-'.$ginza_opt['product_per_row_over1400'];
		}
		$classes[] = $colwidth_over1400 ;
	}
}
