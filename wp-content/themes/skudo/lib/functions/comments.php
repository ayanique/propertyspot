 ...
 */
function skudo_comments($comment, $args, $depth) {
...
<li <?php comment_class(); ?>>
	...
	<div class="comment-container">
		<div class="comment-box">
			<div class="comment-autor two columns alpha omega" >
			...
			<div class="comment-reply" >
				...
				<div class="comment-date post-info">
					...
					<div class="reply">
						<?php if (!function_exists('icl_object_id')) comment_reply_link(array_merge( $args, array('depth' => $depth, 'reply_text'=> get_option("skudo_reply_text")))); else comment_reply_link(array_merge( $args, array('depth' => $depth, 'reply_text'=> esc_html__("Reply", "skudo")))); ?>
