			...
			switch($field['type']){
				...
				case 'upload':
					...
					$skudo_admin_inline_script .= '
						jQuery(document).ready(function(){ 
							"use strict";
							skudoOptions.loadUploader(jQuery("div#'.esc_js($button_id).'"), "'.SKUDO_UTILS_URL.'upload-handler.php", "'.SKUDO_UPLOADS_URL.'");
						});
					';
				...
				case 'upload2':
					...
					$skudo_admin_inline_script .= '
						jQuery(document).ready(function(){ 
							"use strict";
							skudoOptions.loadUploader(jQuery("div#'.esc_js($button_id).'2"), "'.SKUDO_UTILS_URL.'upload-handler.php", "'.SKUDO_UPLOADS_URL.'");
						});
					';
					wp_add_inline_script('skudo-admin', $skudo_admin_inline_script, 'after');
