		...
		<div class="nav-container <?php if (get_option("skudo_header_full_width") == "off") echo " container"; ?>">
			...
			<div class="navbar-collapse collapse">
				...
				<?php 
					...
					<?php
					//search trigger
					if (get_option("skudo_enable_search") == "on" && $typeofheader != "style4"){
						?>
						<div class="search_trigger"><div class="icon dripicons-search"></div></div>
						<?php
					}
					
					skudo_print_woocommerce_button();
					...
					if (get_option("skudo_social_icons_menu") == "on" ){
						...
						foreach ($icons as $i){
							if (is_string(get_option("skudo_icon-".$i[0])) && get_option("skudo_icon-".$i[0]) != ""){
							?>
								<span class="social_container <?php echo esc_attr(strtolower($i[0])); ?>_container" data-href="<?php echo esc_attr(esc_url(get_option('skudo_icon-'.$i[0]))); ?>" >
			...
			<div class="header_style2_contact_info">
				<?php
					...
					if (get_option('skudo_style2_email_menu') != ""){
						?>
						<div class="email-contact">
							<div class="icon"><i class="icon dripicons-message"></i></div>
							<div class="details">
								<?php
									if (get_option('skudo_style2_email_slogan') != ""){
										?>
										<div class="slogan"><?php echo esc_html(get_option('skudo_style2_email_slogan')); ?></div>
										<?php
									}
								?>
								<div class="email"><a href="mailto:<?php echo esc_attr(get_option('skudo_style2_email_menu')); ?>"><?php echo esc_html(get_option('skudo_style2_email_menu')); ?></a></div>
							</div>
						</div>
						<?php
					}
					if (get_option('skudo_style2_telephone_menu') != ""){
						?>
						<div class="telephone-contact">
							<div class="icon"><i class="icon dripicons-phone"></i></div>
							<div class="details">
								<?php
									if (get_option('skudo_style2_telephone_slogan') != ""){
										?>
										<div class="slogan"><?php echo esc_html(get_option('skudo_style2_telephone_slogan')); ?></div>
										<?php
									}
								?>
								<div class="email"><?php echo esc_html(get_option('skudo_style2_telephone_menu')); ?></div>
							</div>
						</div>
						<?php
					}
